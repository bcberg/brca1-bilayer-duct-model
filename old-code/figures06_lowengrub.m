...
%tiledlayout('flow')
%nexttile
semilogy(tA1,(solA1(:,1)),'DisplayName','Basal','Color',green)
set(gca,'FontSize',24)
set(gca,'DefaultLineLineWidth', 2)
hold on
semilogy(tA1,(solA1(:,2)),'DisplayName','Luminal','Color',red)
semilogy(tA1,(solA1(:,3)),'DisplayName','BLI','Color',yellow)
...
set(gca,'FontSize',24)
set(gca,'DefaultLineLineWidth', 2)
semilogy(tA2,solA2(:,1),'DisplayName','Basal','Color',green)
set(gca,'FontSize',24)
set(gca,'DefaultLineLineWidth', 2)
hold on
semilogy(tA2,solA2(:,2),'DisplayName','Luminal','Color',red)
semilogy(tA2,solA2(:,3),'DisplayName','BLI','Color',yellow)
hold off
xlabel('Time (arb. units)')
ylabel('Cell number (arb. units)')
%ylim([0,100])
